...
- consider the following example
	<Image src="/attachments/IMG-20231207175829.png" width="300px"/>
...
- to characterize this circuit, we plot the voltage transfer characteristics (VTC's) of both inverters using the same pair of axes
	- the 2 VTC's, which can be thought of as curves, intersect at 3 points
		<Image src="/attachments/IMG-20231207175854.png" width="300px"/>
...
- Solution: bistable latch shown below
	![Image](/attachments/IMG-20231207175914.png)
...
- this SR latch has 2 complementary outputs $Q$ and $Q'$
	- *set state*: $Q=1, Q'=0$
	- *reset state*: $Q=0, Q'=1$
	![Image](/attachments/IMG-20231207175926.png)
- Truth table
...
- a NOR-based SR latch can also be implemented (instead of INV) → using nmos instead of cmos
	<Image src="/attachments/IMG-20231207175940.png" width="500px"/>
...
- additionally, a NAND-based SR latch can also be implemented
	<Image src="/attachments/IMG-20231207175954.png" width="500px"/>
...
### NOR-Based SR Latch
- AND → NOR gates
	<Image src="/attachments/IMG-20231207180008.png" width="450px"/>
- when CK=0, inputs have no influence on outputs
- when CK=1, S and R are permitted to reach SR latch
- Operation
	![Image](/attachments/IMG-20231207180019.png)
...
- *AOI*: AND-OR-INVERT
	![Image](/attachments/IMG-20231207180029.png)
### NAND-Based SR Latch
- OR → NAND gates
	<Image src="/attachments/IMG-20231207180039.png" width="450px"/>
...
- NAND → NAND gates
	<Image src="/attachments/IMG-20231207180055.png" width="450px"/>
- we can also think of it as
	<Image src="/attachments/IMG-20231207180109.png" width="450px"/>
...
- this problem can be solved by adding 2 feedback lines from outputs to inputs
	<Image src="/attachments/IMG-20231207180121.png" width="450px"/>
	- when CK=1 and $J=K=1$, outputs will simply toggle
#### All-NAND implementation of JK latch
- all NAND gates
	<!-- ![Image](/attachments/📖%Spelling%Correction%&%Statistical%Machine%Translation_jpg_6.png) -->
#### NOR-based JK latch with AOI realization
- from [[Sequential Logic Design Part I#AOI-Based Implementation]]
	![Image](/attachments/IMG-20231207180134.png)
- simplified to
	<Image src="/attachments/IMG-20231207180145.png" width="400px"/>
...
- to prevent this undesirable timing problem, the clock pulse width must be made smaller than the propagation delay of the JK latch circuit
	- this means the clock signal must go low before the output level has the opportunity to switch again, preventing the uncontrolled oscillation of the output
		![Image](/attachments/IMG-20231207180208.png)
...
- *master*: input latch, *slave*: output latch
	![Image](/attachments/IMG-20231207180231.png)
...
- AND → NOR → AND → NOR
	![Image](/attachments/IMG-20231207180243.png)
...
- we return to [[Sequential Logic Design Part I#NOR-Based SR Latch]], where we modify it to obtain a D Latch
	...
	<Image src="/attachments/IMG-20231207180258.png" width="450px"/>
	- when CK=1, $Q=D$
...
- using just TG’s
	<Image src="/attachments/IMG-20231207180309.png" width="450px"/>
	- when CK=1
